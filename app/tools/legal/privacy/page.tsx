...
const sections = [
  ...
  ["付款信息","Payment Information",
   "付款资料由 Paddle 收集和处理。BaiheAI Factory Tools 不接收或保存买家的完整银行卡号。",
   "Payment details are collected and processed by Paddle. BaiheAI Factory Tools does not receive or store the buyer's full card number."],
