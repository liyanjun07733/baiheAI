          ...
          relatedLinks={[
            {
              ...
              desc: "把公司、政策、场地、设备、人员和投产准备放到同一张时间表，先理清 BOI 判断与其他事项的前后关系。",
              href: "/blog/thailand-investment-timeline",
            },
            {
              title: "泰国 BOI 申请指南",
              desc: "继续查看 BOI 申请前需要准备的项目资料、判断重点和后续办理路径。",
              href: "/guides/thailand-boi-application",
            },
            {
              title: "泰国投资咨询",
              desc: "如果项目活动、设备、人员或投资安排还不清晰，可以先做前期项目梳理，再判断是否值得进入 BOI 评估。",
