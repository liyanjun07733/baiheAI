    ...
    <footer className="relative overflow-hidden border-t border-white/10 bg-[#030711] text-gray-400">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 sm:px-6 md:px-8 md:py-20">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <FadeUp>
            <div>
              <Link href="/" className="inline-flex text-3xl font-black text-white">
                Baihe
          ...
          <FadeUp delay={0.3}>
            <div>
              ...
              <div className="mt-5 space-y-3">
                <a href="tel:+66964080781" className="block rounded-xl border border-cyan-500/15 bg-cyan-500/[0.05] px-4 py-3 text-cyan-300">
                  📞 +66 964080781
                </a>
                <a href="https://line.me/ti/p/~liyanjun0773" target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-green-500/15 bg-green-500/[0.05] px-4 py-3 text-green-300">
                  💬 LINE：liyanjun0773
                </a>
                <a href="https://wa.me/8613003137828" target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-green-500/15 bg-green-500/[0.05] px-4 py-3 text-green-300">
                  🟢 WhatsApp
                </a>
                <a href="mailto:liyanjun07733@gmail.com" className="block break-all rounded-xl border border-blue-500/15 bg-blue-500/[0.05] px-4 py-3 text-blue-300">
