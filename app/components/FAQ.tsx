...
const faqs = [
  ...
  {
    question: "验厂服务是帮助工厂准备，还是可以代客户去泰国验厂？",
    answer:
      "两种都可以。第一类是工厂验厂辅导，帮助工厂在客户来厂前梳理现场、资料、流程、沟通与整改事项；第二类是客户委托现场验厂，当客户没有时间亲自到泰国时，我们可按事先确认的重点赴供应商或工厂现场考察、拍照记录并沟通。商业现场考察不替代认证机构或法定第三方的正式审核结论。",
  },
  {
