      ...
      <FadeUp>
        <div className="mx-auto max-w-7xl overflow-hidden rounded-3xl border border-cyan-500/20 bg-gradient-to-r from-blue-600/15 via-cyan-500/10 to-blue-600/15 p-7 text-center sm:p-10 md:p-14">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link href="/consultation?from=home-cta" className="rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 px-7 py-4 font-bold text-white">1 分钟项目需求诊断</Link>
            <Link href="/free-plan" className="rounded-xl border border-cyan-400/25 bg-cyan-400/[0.06] px-7 py-4 font-bold text-cyan-200">提交详细项目需求</Link>
