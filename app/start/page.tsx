          ...
          <div className="relative mx-auto max-w-6xl">
            <div className="max-w-4xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <Link href="/consultation?from=start" className="rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 px-6 py-3.5 text-center font-black text-white">1 分钟项目需求诊断</Link>
